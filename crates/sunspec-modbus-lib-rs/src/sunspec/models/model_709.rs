...
#[repr(C)]
pub struct Model709StatefulPtrAdapter {
    /// DER Trip LF Module Enable (Ena)
    ///
    /// DER low frequency trip control enable.
    pub der_trip_lf_module_enable: Model709Ena,
    ...
    /// Scale factor for curve time points.
    pub time_point_scale_factor: i16,
    pub stored_curves: *mut Model709StoredCurvesPtr,
}

/// Each repeating-group field points to the first element of a caller-allocated array with at least as many elements as that group's repeat count (the `repeat_count_*` passed for this model); a shorter array is undefined behaviour.
#[repr(C)]
pub struct Model709StoredCurvesPtr {
    /// Curve Access (ReadOnly)
    ///
    /// Curve read-write access.
    pub crv_curve_access: Model709ReadOnly,
    ...
    /// Number of active points in the momentary cessation curve.
    pub momentary_cessation_curve_crv_number_of_active_points: u16,
    pub must_trip_curve_must_trip_curve_points: *mut Model709MustTripCurveMustTripCurvePointsPtr,
    pub may_trip_curve_may_trip_curve_points: *mut Model709MayTripCurveMayTripCurvePointsPtr,
    pub momentary_cessation_curve_mom_cessation_curve_points:
        *mut Model709MomentaryCessationCurveMomCessationCurvePointsPtr,
}

#[repr(C)]
pub struct Model709MustTripCurveMustTripCurvePointsPtr {
    /// Frequency Point (Hz)
    ///
    /// Curve frequency point.
    ///
...
#[repr(C)]
pub struct Model709MayTripCurveMayTripCurvePointsPtr {
    /// Frequency Point (Hz)
    ///
    /// Curve frequency point.
    pub may_trip_curve_pt_frequency_point: u32,
...
#[repr(C)]
pub struct Model709MomentaryCessationCurveMomCessationCurvePointsPtr {
    /// Frequency Point (Hz)
    ///
    /// Curve frequency point.
    pub momentary_cessation_curve_pt_frequency_point: u32,
...
impl ReadAdapter for Model709StatefulPtrAdapter {
    fn der_trip_lf_module_enable(&self) -> Ena {
        self.der_trip_lf_module_enable
    }
...
impl WriteAdapter for Model709StatefulPtrAdapter {
    /// DER Trip LF Module Enable (Ena)
    ///
    /// DER low frequency trip control enable.
    fn set_der_trip_lf_module_enable(&mut self, value: Ena) {
...
unsafe fn model_709_c_visit_read(
    ...
    let adapter: Option<&dyn ReadAdapter> = match kind {
        1 => Some(unsafe { &*(adapter as *const Model709StatefulPtrAdapter) } as &dyn ReadAdapter),
...
unsafe fn model_709_c_visit_write(
    ...
    let adapter: Option<&mut dyn WriteAdapter> = match kind {
        1 => Some(
            unsafe { &mut *(adapter as *mut Model709StatefulPtrAdapter) } as &mut dyn WriteAdapter,
        ),
        2 => {
