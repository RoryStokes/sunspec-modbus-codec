...
#[repr(C)]
pub struct Model707StatefulPtrAdapter {
    /// DER Trip LV Module Enable (Ena)
    ///
    /// DER low voltage trip control enable.
    pub der_trip_lv_module_enable: Model707Ena,
    ...
    /// Scale factor for curve time points.
    pub time_point_scale_factor: i16,
    pub stored_curves: *mut Model707StoredCurvesPtr,
}

/// Each repeating-group field points to the first element of a caller-allocated array with at least as many elements as that group's repeat count (the `repeat_count_*` passed for this model); a shorter array is undefined behaviour.
#[repr(C)]
pub struct Model707StoredCurvesPtr {
    /// Curve Access (ReadOnly)
    ///
    /// Curve read-write access.
    pub crv_curve_access: Model707ReadOnly,
    ...
    /// Number of active points in the momentary cessation curve.
    pub momentary_cessation_curve_crv_number_of_active_points: u16,
    pub must_trip_curve_must_trip_curve_points: *mut Model707MustTripCurveMustTripCurvePointsPtr,
    pub may_trip_curve_may_trip_curve_points: *mut Model707MayTripCurveMayTripCurvePointsPtr,
    pub momentary_cessation_curve_mom_cessation_curve_points:
        *mut Model707MomentaryCessationCurveMomCessationCurvePointsPtr,
}

#[repr(C)]
pub struct Model707MustTripCurveMustTripCurvePointsPtr {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    ///
...
#[repr(C)]
pub struct Model707MayTripCurveMayTripCurvePointsPtr {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    pub may_trip_curve_pt_voltage_point: u16,
...
#[repr(C)]
pub struct Model707MomentaryCessationCurveMomCessationCurvePointsPtr {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    pub momentary_cessation_curve_pt_voltage_point: u16,
...
impl ReadAdapter for Model707StatefulPtrAdapter {
    fn der_trip_lv_module_enable(&self) -> Ena {
        self.der_trip_lv_module_enable
    }
...
impl WriteAdapter for Model707StatefulPtrAdapter {
    /// DER Trip LV Module Enable (Ena)
    ///
    /// DER low voltage trip control enable.
    fn set_der_trip_lv_module_enable(&mut self, value: Ena) {
...
unsafe fn model_707_c_visit_read(
    ...
    let adapter: Option<&dyn ReadAdapter> = match kind {
        1 => Some(unsafe { &*(adapter as *const Model707StatefulPtrAdapter) } as &dyn ReadAdapter),
...
unsafe fn model_707_c_visit_write(
    ...
    let adapter: Option<&mut dyn WriteAdapter> = match kind {
        1 => Some(
            unsafe { &mut *(adapter as *mut Model707StatefulPtrAdapter) } as &mut dyn WriteAdapter,
        ),
        2 => {
